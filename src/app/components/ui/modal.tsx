      ...
      >
        <div className="relative h-full overflow-hidden w-auto">
          <nav className="flex items-center justify-between border-b h-[3.5rem]">
            <nav className="pl-3 my-auto font-semibold text-gray-600">
              {title}
            </nav>
            <IconifyIcon
              onClick={() => closeModal()}
              className="text-gray-700 mr-3 my-auto cursor-pointer"
